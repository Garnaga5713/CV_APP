...
namespace PDF_APP
{
    public partial class Educ_Expi : Form
    {
        ...
        private void Educ_Expi_Load(object sender, EventArgs e)//load default data
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (richTextBox1.Text != "" && richTextBox2.Text != ""&&words.Length>100)//checking if all data input OR sum of data more than 100
            {
                Skills skills = new Skills(levels,language,FIO,mail,richTextBox2.Text,richTextBox1.Text);//next form
                skills.Show();
            }
            else
